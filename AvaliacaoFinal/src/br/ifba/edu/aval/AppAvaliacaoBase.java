...
public abstract class AppAvaliacaoBase {
	...
	public void makeBoletinsProva() {
		...
		this.atleta5 = BoletimProvaFactory.instance().getBoletim("16000", Sexo.D, Idade.INFANTIL, Dificuldade.N, 14L);
	}
	...
	public void runAtleta1Aval1() throws AtividadeNaoPermitidaException {
		...
		this.atleta1.registrar(35, Duration.ofSeconds(210));
		this.atleta1.registrar(36, Duration.ofSeconds(250));
		this.atleta1.registrar(37, Duration.ofSeconds(265));
		this.atleta1.registrar(38, Duration.ofSeconds(320));
		this.atleta1.registrar(39, Duration.ofSeconds(370));
		this.atleta1.registrarChegada(Duration.ofSeconds(375));
